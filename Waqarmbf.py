...
# coding=utf-8
# code by  Mr Waqar AJ
# my facebook ( https://www.facebook.com/Muhammadwaqar0313 )
...
logo = ''' \033[0;96m __  __        __  ______  ____
 \033[0;96m \ \/ / ____  /  |/  / _ )/ __/ ® \033[0m|| Created By  Waqar AJ
 \033[0;96m  \  / /___/ / /|_/ / _  / _/     \033[0m|| Github.com/Waqar AJ HACKER
 \033[0;96m  /_/       /_/  /_/____/_/ \033[0;91mv2.0  \033[0m|| Facebook.com/Muhammadwaqar0313'''
...
def moch_yayan():
    ...
    print '___________________________________________________________\n';time.sleep(0.03)
    print ' [%s1%s].  Crack From Friends'%(O,N);time.sleep(0.03)
    print ' [%s2%s].  Crack From Public'%(O,N);time.sleep(0.03)
    print ' [%s3%s].  Crack From Follower'%(O,N);time.sleep(0.03)
    print ' [%s4%s].  Crack From likes post'%(O,N);time.sleep(0.03)
    print ' [%s5%s].  Start Cloning'%(O,N);time.sleep(0.03)
    print ' [%s6%s].  Check fb account information'%(O,N);time.sleep(0.03)
    print ' [%s7%s].  Check Crack Results'%(O,N);time.sleep(0.03)
    print ' [%s8%s].  User agent settings'%(O,N);time.sleep(0.03)
...
def info_tools():
    ...
    print '\n %s[%s>%s] Author   :  WAQAR X SHEHZADI.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Github   : https://github.com/WaqarXshehzadi'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Facebook : https://www.facebook.com/Muhammadwaqar0313'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Fanspage : https://www.facebook.com/shehzadi'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Instagram: https://www.instagram.com/Waqaraj_'%(N,H,N);time.sleep(0.07)
